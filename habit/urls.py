...
from .views import (ListApiViewUsefulHabit, ListApiViewPleasantHabit, CreateApiViewUsefulHabit,
                    ...
                    DestroyApiViewUsefulHabit, OwnerListApiViewPleasantHabit, OwnerListApiViewUsefulHabit)
...
urlpatterns = [
    ...
    path('useful_habits/my/', OwnerListApiViewUsefulHabit.as_view(), name='my_useful_habits'),
    ...
    path('pleasant_habits/my/', OwnerListApiViewPleasantHabit.as_view(), name='my_pleasant_habits'),
